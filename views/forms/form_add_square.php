                ...
                <div class="card p-4">
                    <form class="row g-3" action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="student_name" placeholder="Ketik nama persegi disini" required>
                        </div>

                        <div class="mb-3">
                            <label for="sisi" class="form-label">Panjang Sisi</label>
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" id="sisi" name="side_square" placeholder="Ketik sisi persegi disini" required>
